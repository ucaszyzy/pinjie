...
set C_modelArgList {
	...
	{ dst_rows_V_read int 32 regular {ap_stable 0} }
	{ dst_cols_V_read int 32 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "src_data_stream_0_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_rows_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "dst_cols_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ dst_rows_V_read sc_in sc_lv 32 signal 3 } 
	{ dst_cols_V_read sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_rows_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_rows_V_read", "role": "default" }} , 
 	{ "name": "dst_cols_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_cols_V_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	dst_rows_V_read { ap_stable {  { dst_rows_V_read in_data 0 32 } } }
	dst_cols_V_read { ap_stable {  { dst_cols_V_read in_data 0 32 } } }
