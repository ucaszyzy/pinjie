...
`define TV_OUT_OUTPUT_STREAM_TDATA "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_data_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TDATA "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_data_V.dat"
`define TV_OUT_OUTPUT_STREAM_TKEEP "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_keep_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TKEEP "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_keep_V.dat"
`define TV_OUT_OUTPUT_STREAM_TSTRB "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_strb_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TSTRB "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_strb_V.dat"
`define TV_OUT_OUTPUT_STREAM_TUSER "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_user_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TUSER "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_user_V.dat"
`define TV_OUT_OUTPUT_STREAM_TLAST "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_last_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TLAST "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_last_V.dat"
`define TV_OUT_OUTPUT_STREAM_TID "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_id_V.dat"
`define EGRESS_STATUS_OUTPUT_STREAM_TID "../tv/stream_size/stream_egress_status_OUTPUT_STREAM_V_id_V.dat"
`define TV_OUT_OUTPUT_STREAM_TDEST "../tv/rtldatafile/rtl.image_filter.autotvout_OUTPUT_STREAM_V_dest_V.dat"
...
module AESL_axi_s_OUTPUT_STREAM (
    ...
    fifo #(2073600, 32) fifo_OUTPUT_STREAM_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 4) fifo_OUTPUT_STREAM_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 4) fifo_OUTPUT_STREAM_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 1) fifo_OUTPUT_STREAM_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 1) fifo_OUTPUT_STREAM_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 1) fifo_OUTPUT_STREAM_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2073600, 1) fifo_OUTPUT_STREAM_TDEST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TDATA
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TDATA);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TDATA, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TDATA, "_", str});
                    $finish;
                end
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TKEEP
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TKEEP);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TKEEP, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TKEEP, "_", str});
                    $finish;
                end
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TSTRB
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TSTRB);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TSTRB, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TSTRB, "_", str});
                    $finish;
                end
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TUSER
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TUSER);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TUSER, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TUSER, "_", str});
                    $finish;
                end
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TLAST
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TLAST);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TLAST, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TLAST, "_", str});
                    $finish;
                end
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TID
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TID);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TID, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TID, "_", str});
                    $finish;
                end
    ...
    initial begin : AXI_stream_receiver_OUTPUT_STREAM_TDEST
        ...
        forever begin
            @ (negedge clk);
            if (done_1 == 1) begin
                $sformat(str, "%0d", transaction_save_OUTPUT_STREAM_TDEST);
                fp = $fopen({`TV_OUT_OUTPUT_STREAM_TDEST, "_", str}, "w");
                if (fp == 0) begin // Failed to open file
                    $display("ERROR: Failed to open file \"%s\"!", {`TV_OUT_OUTPUT_STREAM_TDEST, "_", str});
                    $finish;
                end
