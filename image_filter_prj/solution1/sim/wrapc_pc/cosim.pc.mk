...
$(ObjDir)/opencv_top.cpp_pre.cpp.tb.o : opencv_top.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling opencv_top.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/image_filter.cpp_pre.cpp.tb.o : image_filter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling image_filter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
