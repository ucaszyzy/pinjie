...
reg   [31:0] t_V_3_reg_148;
wire   [32:0] r_V_fu_163_p2;
reg   [32:0] r_V_reg_248;
wire   [0:0] exitcond5_fu_174_p2;
wire    ap_CS_fsm_state2;
wire   [31:0] i_V_fu_179_p2;
...
wire   [31:0] j_V_fu_190_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] axi_last_V_fu_200_p2;
reg   [0:0] axi_last_V_reg_271;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg   [31:0] t_V_reg_137;
wire    ap_CS_fsm_state5;
reg    AXI_video_strm_V_id_V1_update;
reg    ap_block_pp0_stage0_01001;
reg   [0:0] tmp_user_V_fu_80;
wire   [32:0] lhs_V_cast_fu_159_p1;
wire   [32:0] tmp_cast_fu_196_p1;
wire   [63:0] val_assign_1_1_fu_213_p1;
wire   [63:0] val_assign_1_fu_209_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond5_fu_174_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_185_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_262 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_user_V_fu_80 <= 1'd0;
    end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_user_V_fu_80 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_fu_185_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((exitcond_fu_185_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((exitcond5_fu_174_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((exitcond5_fu_174_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_185_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_185_p2 == 1'd1))) begin
...
assign AXI_video_strm_V_data_V_din = {{val_assign_1_1_fu_213_p1}, {val_assign_1_fu_209_p1}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_262 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_262 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_reg_262 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

assign ap_block_state3_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_reg_262 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_reg_262 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign axi_last_V_fu_200_p2 = ((tmp_cast_fu_196_p1 == r_V_reg_248) ? 1'b1 : 1'b0);

assign exitcond5_fu_174_p2 = ((t_V_reg_137 == img_rows_V_read) ? 1'b1 : 1'b0);

assign exitcond_fu_185_p2 = ((t_V_3_reg_148 == img_cols_V_read) ? 1'b1 : 1'b0);

assign i_V_fu_179_p2 = (t_V_reg_137 + 32'd1);

assign j_V_fu_190_p2 = (t_V_3_reg_148 + 32'd1);

assign lhs_V_cast_fu_159_p1 = img_cols_V_read;

assign r_V_fu_163_p2 = ($signed(lhs_V_cast_fu_159_p1) + $signed(33'd8589934591));

assign tmp_cast_fu_196_p1 = t_V_3_reg_148;

assign val_assign_1_1_fu_213_p1 = img_data_stream_1_V_dout;

assign val_assign_1_fu_209_p1 = img_data_stream_0_V_dout;
